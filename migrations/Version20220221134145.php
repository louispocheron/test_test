 ...
 */
final class Version20220221134145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE associations (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(1000) NOT NULL, logo VARCHAR(3000) NOT NULL, description VARCHAR(5000) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
